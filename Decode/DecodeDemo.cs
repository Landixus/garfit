...
namespace DecodeDemo
{
	class Program
	{
		...
		private static void MesgBroadcaster_GeneralMesgEvent(object sender, MesgEventArgs e)
        {
			Console.WriteLine("{0}", e.mesg.ToString());
        }
		...
		{
			Console.WriteLine("OnMesg: Received Mesg with global ID#{0}, its name is {1}",
							  e.mesg.Num,
							  e.mesg.Name);
