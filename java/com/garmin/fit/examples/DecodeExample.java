...
public class DecodeExample {
	public static void main(String[] args) {
		...
		// decode.skipHeader(); // Use on streams with no header and footer (stream
		// contains FIT defn and data messages only)
		// decode.incompleteStream(); // This suppresses exceptions with unexpected eof
		// (also incorrect crc)
		...
		/*
		 * if (args.length != 1) {
		 * System.out.println("Usage: java -jar DecodeExample.jar <filename>"); return;
		 * }
		 */

		String fileName = "C:\\Users\\nhdinh\\Desktop\\GarFit\\files\\1.fit";
	...
	private static class Listener
			implements FileIdMesgListener, UserProfileMesgListener, DeviceInfoMesgListener, MonitoringMesgListener,
			RecordMesgListener, DeveloperFieldDescriptionListener, AccelerometerDataMesgListener {
		...
		public void onMesg(MonitoringMesg mesg) {
			...
			// Depending on the ActivityType, there may be Steps, Strokes, or Cycles present
			// in the file
